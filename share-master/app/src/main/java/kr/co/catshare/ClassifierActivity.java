...
import kr.co.catshare.env.BorderedText;
import kr.co.catshare.env.Logger;
import kr.co.catshare.tflite.Classifier;
import kr.co.catshare.tflite.Classifier.Device;

import java.io.IOException;
import java.util.List;

public class ClassifierActivity extends com.example.cap02.CameraActivity implements OnImageAvailableListener {
